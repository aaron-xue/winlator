...
static char *get_native_library_dir(JNIEnv *env, jobject context) {
    ...
    jclass class_ = 
        (*env)->FindClass(env,"com/winlator/cmod/core/AppUtils");
    if (class_ == NULL) { 
...
static char *get_library_name(JNIEnv *env, jobject context, 
    ...
    jclass adrenotoolsManager = (*env)->FindClass(
        env, "com/winlator/cmod/contents/AdrenotoolsManager");
...
Java_com_winlator_cmod_core_GPUInformation_getVulkanVersion(
...
Java_com_winlator_cmod_core_GPUInformation_getVendorID(
    JNIEnv *env, jclass obj, jstring driverName, jobject context) {
    VkPhysicalDeviceProperties props = {};
    uint32_t vendorID;
...
JNIEXPORT jstring JNICALL
Java_com_winlator_cmod_core_GPUInformation_getRenderer(
    JNIEnv *env, jclass obj, jstring driverName, jobject context) {
    VkPhysicalDeviceProperties props = {};
...
Java_com_winlator_cmod_core_GPUInformation_enumerateExtensions(
    JNIEnv *env, jclass obj, jstring driverName, jobject context) {
